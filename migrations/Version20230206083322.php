 ...
 */
final class Version20230206083322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tel (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, inventaire_id INT DEFAULT NULL, appareil_id INT DEFAULT NULL, marque_id INT DEFAULT NULL, modele_id INT DEFAULT NULL, libelle_tel VARCHAR(255) NOT NULL, last_modif_tel DATE NOT NULL, quantite_tel INT NOT NULL, num_serie VARCHAR(255) DEFAULT NULL, INDEX IDX_F037AB0FFB88E14F (utilisateur_id), INDEX IDX_F037AB0F642B8210 (admin_id), INDEX IDX_F037AB0FCE430A85 (inventaire_id), INDEX IDX_F037AB0FBF6A0032 (appareil_id), INDEX IDX_F037AB0F4827B9B2 (marque_id), INDEX IDX_F037AB0FAC14B70A (modele_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
