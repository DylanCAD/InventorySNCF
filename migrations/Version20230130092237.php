 ...
 */
final class Version20230130092237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE objet ADD marque_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE objet ADD CONSTRAINT FK_46CD4C384827B9B2 FOREIGN KEY (marque_id) REFERENCES marque (id)');
        $this->addSql('CREATE INDEX IDX_46CD4C384827B9B2 ON objet (marque_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_46CD4C384827B9B2 ON objet');
        $this->addSql('ALTER TABLE objet DROP marque_id');
    }
}
